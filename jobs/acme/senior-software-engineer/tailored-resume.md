...
Senior full-stack engineer with 6+ years building SaaS products in TypeScript, React, and Node.js. Owns TypeScript APIs and React dashboards end-to-end—from backend contracts through customer-facing UI—with a focus on reliable cloud integrations, CI/CD, and production observability.

## Work Experience

### Senior Software Engineer — Example Co (2021–Present)

- Built TypeScript REST and GraphQL APIs in Node.js and PostgreSQL for customer account, reporting, and admin workflows used by 2M+ monthly active users.
...
- Added Datadog dashboards and alerts for latency, error-rate, and queue-depth trends, improving observability and giving on-call engineers faster signals for production regressions.
